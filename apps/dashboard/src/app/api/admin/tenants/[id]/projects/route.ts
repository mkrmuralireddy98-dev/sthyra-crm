/**
 * /api/admin/tenants/[id]/projects — proxy to admin-service.
 */
...
export async function GET(
 ...
 return forward(req, `/v1/admin/tenants/${params.id}/projects`, 'GET');
}
...
export async function POST(
 ...
 return forward(req, `/v1/admin/tenants/${params.id}/projects`, 'POST');
}
